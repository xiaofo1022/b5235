...
import com.xiaofo1022.b5235.inceptor.AcceptHeaderHttpRequestInterceptor;
...
public class HttpBaseService {
  ...
  public byte[] download(String imageUrl) {
    ClientHttpRequestInterceptor acceptHeaderPdf = new AcceptHeaderHttpRequestInterceptor("image/jpeg");
